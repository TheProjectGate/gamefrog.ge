  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (mode === 'register') {
      ...
      try {
        ...
        console.error('[RegisterModal] Login error:', err);
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full h-10 text-base text-black bg-white px-3 py-1 border-2 focus:outline-none focus:ring-2 focus:ring-[#FFD700] transition ${touched.firstName && fieldErrors.firstName ? 'border-red-500' : 'border-black'
                            }`}
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full h-10 text-base text-black bg-white px-3 py-1 border-2 focus:outline-none focus:ring-2 focus:ring-[#FFD700] transition ${touched.lastName && fieldErrors.lastName ? 'border-red-500' : 'border-black'
                            }`}
                        />
                    ...
                    <div className="grid grid-cols-6 gap-2">
                      {AVATARS.map((avatar) => (
                        <button
                          ...
                          className={`w-full aspect-square border-2 overflow-hidden bg-gray-100 transition-all ${selectedAvatar === avatar.id
                ...
                <div className="p-4 space-y-3 bg-white">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full h-10 text-base text-black bg-white px-3 py-1 border-2 focus:outline-none focus:ring-2 focus:ring-[#FFD700] transition ${touched.email && fieldErrors.email ? 'border-red-500' : 'border-black'
                        }`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full h-10 text-base text-black bg-white px-3 py-1 border-2 focus:outline-none focus:ring-2 focus:ring-[#FFD700] transition ${touched.password && fieldErrors.password ? 'border-red-500' : 'border-black'
                        }`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full h-10 text-base text-black bg-white px-3 py-1 border-2 focus:outline-none focus:ring-2 focus:ring-[#FFD700] transition ${touched.confirmPassword && fieldErrors.confirmPassword ? 'border-red-500' : 'border-black'
                        }`}
                    />
